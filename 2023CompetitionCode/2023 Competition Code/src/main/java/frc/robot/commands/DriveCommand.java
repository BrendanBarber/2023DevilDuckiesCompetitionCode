...
public class DriveCommand extends CommandBase{
    ...
    public void execute() {
        ...
        if (Math.abs(y) >= Constants.DrivetrainCharacteristics.deadband) {
            ...
            double turnControlEffort = x * Constants.DrivetrainCharacteristics.turnSpeedScale;
            drivetrainSubsystem.robotDrive.tankDrive(turnControlEffort, -turnControlEffort);
        }
    }
